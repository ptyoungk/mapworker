    ...
    return (
      <Content style={styles.content}>
        <List>
          ...
          <ListItem onPress={() => this.props.navigation.navigate("map_dteailList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
            />
            <Text>List map_dteail</Text>
          </ListItem>
          
          <ListItem onPress={() => this.props.navigation.navigate("mapinfoList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
            />
            <Text>List mapinfo</Text>
          </ListItem>
          {/* END MY SCREENS */}
