...
function getConnection() {
	...
	global $db_mapworker_db_Url, $db_mapworker_db_User, $db_mapworker_db_Pass, $db_mapworker_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_mapworker_db_Url.";dbname=".$db_mapworker_db_DbName, $db_mapworker_db_User, $db_mapworker_db_Pass);
